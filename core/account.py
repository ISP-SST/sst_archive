...
_SWEDISH_USER_HELP_TEXT = '<strong>IMPORTANT:</strong> By specifying that you are a Swedish user your account will ' \
                          'be put through a manual verification process before you will be able to access data ' \
                          'generated by Swedish Universities. If you are not a affiliated with a Swedish university, ' \
                          'do not check this box.'

_PURPOSE_HELP_TEXT = 'Please provide a brief description of the purpose for the account, e.g. what type of data you ' \
                     'are interested in.'

_EMAIL_HELP_TEXT = 'Please provide an e-mail address belonging to your affiliation (University) ' \
