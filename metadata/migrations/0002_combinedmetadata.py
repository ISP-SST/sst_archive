...
def update_combined_metadata(apps, schema_editor):
    ...
    for instrument in Instrument.objects.all():
        metadata_model = apps.get_model(instrument.metadata_content_type.app_label,
                                        instrument.metadata_content_type.model)

        for old_metadata in metadata_model.objects.all():
            print("Old metadata data_location", old_metadata.data_location)
            data_location = old_metadata.data_location
            old_metadata_dict = model_to_dict(old_metadata)
            del old_metadata_dict['data_location']
            new_metadata = CombinedMetadata(**old_metadata_dict)
            print("new_metadata.data_location: ", new_metadata.data_location)
            new_metadata.data_location = data_location
            new_metadata.save()
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='metadata', to='dataset.datalocation')),
            ],
            options={
        ...
        migrations.RunPython(update_combined_metadata),
    ]
