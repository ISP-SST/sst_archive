...
class Chromis(BaseMetadata):
    ...
    datakurt = models.FloatField(verbose_name='DATAKURT', help_text='The kurtosis (provided value)', blank=True,
                                 null=True)
    ...
    datamean = models.FloatField(verbose_name='DATAMEAN', help_text='The average data value (provided value)',
                                 blank=True, null=True)
    datamedn = models.FloatField(verbose_name='DATAMEDN', help_text='The median data value (provided value)',
                                 blank=True, null=True)
    datamin = models.FloatField(verbose_name='DATAMIN', help_text='The minimum data value (provided value)', blank=True,
                                null=True)
    datap01 = models.FloatField(verbose_name='DATAP01', help_text='The 01 percentile (provided value)', blank=True,
                                null=True)
    datap10 = models.FloatField(verbose_name='DATAP10', help_text='The 10 percentile (provided value)', blank=True,
                                null=True)
    datap25 = models.FloatField(verbose_name='DATAP25', help_text='The 25 percentile (provided value)', blank=True,
                                null=True)
    datap75 = models.FloatField(verbose_name='DATAP75', help_text='The 75 percentile (provided value)', blank=True,
                                null=True)
    datap90 = models.FloatField(verbose_name='DATAP90', help_text='The 90 percentile (provided value)', blank=True,
                                null=True)
    datap95 = models.FloatField(verbose_name='DATAP95', help_text='The 95 percentile (provided value)', blank=True,
                                null=True)
    datap98 = models.FloatField(verbose_name='DATAP98', help_text='The 98 percentile (provided value)', blank=True,
                                null=True)
    datap99 = models.FloatField(verbose_name='DATAP99', help_text='The 99 percentile (provided value)', blank=True,
                                null=True)
    datarms = models.FloatField(verbose_name='DATARMS', help_text='The RMS deviation from the mean (provided value',
                                blank=True, null=True)
    dataskew = models.FloatField(verbose_name='DATASKEW', help_text='The skewness (provided value)', blank=True,
                                 null=True)
    date = models.DateTimeField(verbose_name='DATE', help_text='Creation UTC date of FITS header', blank=True,
                                null=True)
    date_avg = models.DateTimeField(verbose_name='DATE-AVG', help_text='Average time of observation (provided value)',
                                    blank=True, null=True)
    date_obs = models.DateTimeField(verbose_name='DATE-OBS', help_text='Inferred from directory.', blank=True,
                                    null=True)
    dateref = models.DateTimeField(verbose_name='DATEREF', help_text='Reference time in ISO-8601', blank=True,
                                   null=True)
    ...
    obs_hdu = models.BigIntegerField(verbose_name='OBS_HDU', help_text='Observational Header and Data Unit', blank=True,
                                     null=True)
    ...
    prlib2 = models.TextField(verbose_name='PRLIB2', help_text='Software library containing chromis::make_wb_cu',
                              blank=True, null=True)
    ...
    prlib3 = models.TextField(verbose_name='PRLIB3', help_text='Software library containing chromis::make_nb_cu',
                              blank=True, null=True)
    ...
    prlib4 = models.TextField(verbose_name='PRLIB4', help_text='Software library containing red::fitscube_expor',
                              blank=True, null=True)
